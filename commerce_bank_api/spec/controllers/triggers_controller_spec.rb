...
RSpec.describe TriggersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new trigger" do

        post :create, params: {trigger: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(trigger_url(Trigger.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new trigger" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the trigger" do
        trigger = Trigger.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the trigger" do
        trigger = Trigger.create! valid_attributes
